    ...
    return (
        <div className="flex justify-center items-center">
            <div className="flex bg-pink-500 p-1 rounded-lg shadow-lg w-full max-w-md mb-4 items-center">
                <img src={user.picture || default_profile_picture} alt={`${user.username}'s profile`} className="object-fill cursor-pointer w-10 h-10 p-1 ml-2 rounded-full ring-2 ring-white dark:pink-500"></img>
                <div className='ml-5'>
